...
class EventDetail extends Component {
	...
	render() {
		...
		let displayDate = new Date(date).toLocaleDateString('en-US',{ weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' });
			...
			<div className={`event-detail__container flip-container ${this.state.flipped ? 'flip-container-flip' : ''}`}>
				<div className="event-detail__card flipper">
					<div className="event-detail__card_front">
						...
						<a className="event-detail__link" href={url}><div className="event-detail__detail">
